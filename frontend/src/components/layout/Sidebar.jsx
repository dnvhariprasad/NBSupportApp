...
import { GitBranch, Users, Compass, Settings, Briefcase, UsersRound, Database, Building2 } from 'lucide-react';
...
const Sidebar = () => {
    const navItems = [
        ...
        { name: 'Dept Admin', path: '/dashboard/dept-admin', icon: Building2 },
    ];
